    ...
    <footer class="p-4 bg-black sm:p-6 ">
      <div class="sm:grid sm:justify-between">
        <div class="mb-6 sm:mb-0">
          <a href="#" class="flex items-center">
            ...
            <span class="self-center text-5xl text-white font-semibold whitespace-nowrap sm:hidden">
              FITNESS WIN
            </span>
          </a>
        </div>
        <div class="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-1">
          <div>
            <h2 class="mb-6 text-2xl font-semibold text-gray-100 uppercase dark:text-white">
              Ressources
            </h2>
          ...
          <div className="sm:">
            ...
            <ul class="text-white dark:text-gray-400">
              <li class="mb-4">
                <a href="/construction" class="hover:underline">
                  PRIVACY POLICY
                </a>
              </li>
              <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-left sm:text-xs dark:text-gray-400">
          © 2023, made with ❤️ by{" "}
          <a href="https://clementramos.com/" class="hover:underline">
            Clément Ramos
          </a>
          . All Rights Reserved.
        </span>
