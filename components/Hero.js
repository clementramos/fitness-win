...
export default function Hero() {
  return (
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://fitnesswin.com/" class="hover:underline">fitnesswin™</a>. All Rights Reserved.
        </span>
