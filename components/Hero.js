...
export default function Hero() {
    ...
    return ( <
        ...
        /button> <
        p className = "text-white text-center text-xl sm:text-2xl pb-5 pt-5 pr-5" > Je vous propose différents cours de sports de premiers pas à expert. { /*<img src="/youtube.png" alt="youtube channel" className="h-24"></img>*/ } <
        /p> {
        ...
        <
        Image src = "/PROGRAMMES VIDEOS.png"
        alt = "programme"
        width = { 1200 }
        height = { 687 }
        ...
        p className = "pt-8 pb-8 text-md font-thin px-80 sm:px-5 sm:text-justify" > Il est temps de rejoindre une communauté de sportifs déterminés à atteindre leurs objectifs fitness.Avec un coach diplômé et expérimenté, vous bénéficierez d 'un encadrement personnalisé pour atteindre vos objectifs. Que vous cherchiez à améliorer votre condition physique, à perdre du poids ou à vous préparer pour une compétition, je vous aiderai à mettre en place un plan d'
        entraînement sur mesure pour atteindre vos objectifs de manière efficace.Rejoindre notre communauté de sportifs, c 'est également bénéficier de l'
        énergie et de l 'entraide de personnes qui partagent les mêmes passions et les mêmes objectifs que vous. N'
        attendez plus pour vous lancer et atteindre vos objectifs sportifs. < /p> <
        ...
        <
        a href = "/contact"
        className = "uppercase" > Découvrir les cours < /a> <
        /button> <
        /div> <
        /div> <
        ...
        <
        div class = "bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md sm:py-5 sm:text-xl sm:w-full"
        role = "alert" >
        <
        div class = "flex" >
        <
