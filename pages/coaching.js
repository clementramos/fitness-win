...
export default function Coaching () {
    return (
        ...
        <Head/>
        <Navbar />
        <div class="flex items-center justify-center h-full bg-no-repeat bg-cover bg-coaching sm:bg-coachingsm">
            <div className="text-center sm:w-full sm:p-5 pt-12 h-screen">
            <p className="text-white text-center text-[9rem] sm:text-5xl sm:w-full sm:pb-5 sm:pt-12 sm:text-center uppercase font-bold tracking-tighter">coaching personnalisé</p>
        ...
        <div id="coach" className="pt-12 pb-12 h-full bg-white">
            <div className="grid grid-cols-2 sm:grid sm:grid-cols-1">
                <div className="pl-12">
                    <p className="text-black text-left text-[3rem] sm:text-5xl sm:w-full sm:pr-5 sm:text-left p-12 uppercase font-bold tracking-tighter">Accélérez votre progression <br></br> avec un coaching personnalisé <br></br> sur mesure</p>
                    <p className="text-black text-left text-xl sm:text-2xl sm:pr-5 p-12">Le coaching personnalisé est une approche sur mesure qui vous permet de réaliser vos objectifs personnels en matière de santé et de bien-être. 
                    ...
                    <button class="bg-black hover:bg-white hover:border-2 hover:border-current text-white font-semibold hover:text-black py-2 px-4 ml-12 border border-white hover:border-transparent rounded-none">
