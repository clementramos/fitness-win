    ...
    return (
        ...
        <div id="groupe" className="pt-12 pb-12 h-full bg-white">
            <div className="grid grid-cols-2 sm:grid sm:grid-cols-1">
                <div className="pl-12">
                    <p className="text-black text-left text-[3rem] sm:text-5xl sm:w-full sm:pr-5 sm:text-left p-12 uppercase font-bold tracking-tighter">Rejoignez la communauté de fitness dynamique et atteignez vos objectifs ensemble !</p>
                    <p className="text-black text-left text-xl sm:text-2xl sm:pr-5 p-12">
                    ...
                    <button class="bg-black hover:bg-white hover:border-2 hover:border-black text-white font-semibold hover:text-black py-2 px-4 ml-12 border border-white hover:border-black rounded-none">
