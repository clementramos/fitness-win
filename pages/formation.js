    ...
    return (
        ...
        <div class="flex items-center justify-center h-screen bg-no-repeat bg-cover bg-formation">
            ...
            <p className="text-white text-center text-[9rem] sm:text-5xl sm:w-full sm:pb-5 sm:pt-48 sm:text-center uppercase font-bold tracking-tighter">formation</p>
              <p className="text-white text-center text-4xl sm:text-3xl font-light uppercase p-12">Pour les futurs coachs ou professionnels en activité de remise en forme.</p>
        ...
        <div id="coach" className="pt-12 pb-12 h-full bg-white">
            ...
            <div className="sm:pl-5">
                    <p className="text-black text-left text-[3rem] sm:text-5xl sm:w-full sm:pr-5 sm:text-left px-12 uppercase font-bold tracking-tighter">Transformez votre passion <br></br> pour le sport en une carrière épanouissante</p>
                    <p className="text-black text-left text-xl sm:text-2xl sm:pr-5 px-12">
                    ...
                    <button class="bg-black hover:bg-white hover:border-2 hover:border-black text-white font-semibold hover:text-black py-2 px-4 ml-12 mt-12 border border-white hover:border-transparent rounded-none">
